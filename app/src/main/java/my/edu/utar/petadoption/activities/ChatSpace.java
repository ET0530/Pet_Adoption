...
import my.edu.utar.petadoption.adapters.RecentConversationsAdapter;
import my.edu.utar.petadoption.databinding.ActivityChatSpaceBinding;
import my.edu.utar.petadoption.listeners.ConversionListener;
...
public class ChatSpace extends BaseActivity implements ConversionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChatSpaceBinding.inflate(getLayoutInflater());
